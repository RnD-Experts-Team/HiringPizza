...
class ReferenceCatalogSyncRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'positions.*.label' => ['required_without:positions.*.id', 'string', 'max:255'],
            ...
            'marital_statuses.*.id' => ['sometimes', 'integer', 'exists:marital_statuses,id'],
            ...
            'marital_status_delete_ids.*' => ['required', 'integer', 'exists:marital_statuses,id'],
            ...
            'attachment_types.*.id' => ['sometimes', 'integer', 'exists:attachment_types,id'],
            ...
            'attachment_type_delete_ids.*' => ['required', 'integer', 'exists:attachment_types,id'],
